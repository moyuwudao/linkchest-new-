...
# 清理 android/app/build-china
rm -rf /mnt/d/trae_projects/linkchest/project/apps/mobile/android/app/build-china
rm -rf /mnt/d/trae_projects/linkchest/project/apps/mobile/android/build-china
echo "OLD_BUILD_CHINA_REMOVED"
